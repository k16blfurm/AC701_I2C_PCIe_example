...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L xdma_v4_1_29"
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/blaine/Vivado_2024.1/Vivado/2024.1/data/xsim"
  fi
