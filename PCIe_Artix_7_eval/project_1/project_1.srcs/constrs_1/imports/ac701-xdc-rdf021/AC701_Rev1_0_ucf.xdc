...
#
#assign gtpe2_common_i.GTREFCLK0 = ref_clk;
#set_property LOC IBUFDS_GTE2_X0Y2 [get_cells refclk_ibuf]
...
##pcie lanes (These are auto assigned....)
#set_property PACKAGE_PIN D10 [get_ports PCIE_TX_P[0]]
#set_property PACKAGE_PIN B9 [get_ports PCIE_TX_P[1]]
#set_property PACKAGE_PIN D8 [get_ports PCIE_TX_P[2]]
#set_property PACKAGE_PIN B7 [get_ports PCIE_TX_P[3]]

#set_property PACKAGE_PIN C10 [get_ports PCIE_TX_N[0]]
#set_property PACKAGE_PIN A9 [get_ports PCIE_TX_N[1]]
#set_property PACKAGE_PIN C8 [get_ports PCIE_TX_N[2]]
#set_property PACKAGE_PIN A7 [get_ports PCIE_TX_N[3]]

#set_property PACKAGE_PIN D12 [get_ports PCIE_RX_P[0]]
#set_property PACKAGE_PIN B13 [get_ports PCIE_RX_P[1]]
#set_property PACKAGE_PIN D14 [get_ports PCIE_RX_P[2]]
#set_property PACKAGE_PIN B11 [get_ports PCIE_RX_P[3]]
...
#I/O setup for pcie
#set_property IOSTANDARD DIFF_SSTL18 [get_ports {PCIE_TX_P[0] PCIE_TX_N[0]}]
#set_property IOSTANDARD DIFF_SSTL18 [get_ports {PCIE_TX_P[1] PCIE_TX_N[1]}]
#set_property IOSTANDARD DIFF_SSTL18 [get_ports {PCIE_TX_P[2] PCIE_TX_N[2]}]
#set_property IOSTANDARD DIFF_SSTL18 [get_ports {PCIE_TX_P[3] PCIE_TX_N[3]}]

#set_property IOSTANDARD DIFF_SSTL18 [get_ports {PCIE_RX_P[0] PCIE_RX_N[0]}]
#set_property IOSTANDARD DIFF_SSTL18 [get_ports {PCIE_RX_P[1] PCIE_RX_N[1]}]
#set_property IOSTANDARD DIFF_SSTL18 [get_ports {PCIE_RX_P[2] PCIE_RX_N[2]}]
#set_property IOSTANDARD DIFF_SSTL18 [get_ports {PCIE_RX_P[3] PCIE_RX_N[3]}]
...
#set_property PACKAGE_PIN K25 [get_ports IIC_SDA_MAIN]
#set_property IOSTANDARD LVCMOS33 [get_ports IIC_SDA_MAIN]
#set_property PACKAGE_PIN K26 [get_ports PCIE_WAKE_B] #tied active low, so nc is fine. doesn't need to be configured
